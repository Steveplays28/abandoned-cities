// Taken from MoStructures, made by frqnny.
// Licensed under LGPL-3.0.
// https://github.com/frqnny/mostructures/blob/1.19.x/src/main/java/io/github/frqnny/mostructures/structure/ModStructure.java

package io.github.steveplays28.abandonedcities.structure;

import com.mojang.serialization.Codec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import io.github.steveplays28.abandonedcities.AbandonedCities;
...
public class ModStructure extends Structure {
	public static final Codec<ModStructure> CODEC = RecordCodecBuilder.create(
	...
	public StructureType<?> getType() {
		return AbandonedCities.GENERIC;
	}
}
